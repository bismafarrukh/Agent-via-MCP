...
async def finder_agent(request: str, app_ctx: Optional[AppContext] = None) -> str:
    ...
    instruction=(
        ...
        "You MUST use the filesystem tool to read the provided university PDF.\n"
        "Answer questions using ONLY the information present in the PDF.\n"
        "If the information is not found in the document, say "
...
async def main():
    async with app.run() as agent_app:
        ...
        request=(
            "Read the file data/university_prospectus.pdf and answer the following:\n\n"
